        ...
        <div className="w-[100%] bg-white shadow-[0px_0px_5px_#ccc] rounded-[10px] p-[20px] m-[-25px] flex items-center">
            ...
            <div className="flex-1 flex items-center">
                <button className="w-[40px] text-center text-[25px] cursor-pointer" onClick={handlePrevMonth}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" color="#116D6E" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
                ...
                <button className="w-[40px] text-center text-[25px] cursor-pointer" onClick={handleNextMonth}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" color="#116D6E" fill="currentColor" class="bi bi-arrow-right-square-fill" viewBox="0 0 16 16">
